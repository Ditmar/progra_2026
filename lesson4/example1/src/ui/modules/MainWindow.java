...
import ui.utils.fonts.Fonts;
import ui.utils.helper.MyCursor;
import ui.utils.palette.MuiColors;
...
public class MainWindow extends JFrame {
    ...
    private void setCheckBox() {
        ...
        yesForm.setBackground(MuiColors.three);
        ...
        noForm.setBackground(MuiColors.three);
    ...
    private void setButton() {
        ...
        button.setForeground(MuiColors.secondary);
        button.setBackground(MuiColors.primary);
        button.setCursor(MyCursor.HAND);
    ...
    private void setTextFields() {
        TextField nameText = new TextField("Nombre de usuario");
    ...
    private void setLabels() {
        ...
        mainTitle.setForeground(MuiColors.three);
        mainTitle.setFont(Fonts.TITLE_H1);
        leftPanel.add(mainTitle);

        JLabel loginTitle = new JLabel("Login");
        loginTitle.setBounds(200, 10, 150, 40);
        loginTitle.setForeground(MuiColors.four);
        loginTitle.setFont(Fonts.TITLE_H2);
        rightPanel.add(loginTitle);

        JLabel description = new JLabel("Recordar credenciales");
        description.setBounds(200, 200, 150, 40);
        description.setForeground(MuiColors.four);
    ...
    private void setContainers() {
        ...
        leftPanel.setBackground(MuiColors.primary);
        rightPanel = new JPanel();
        rightPanel.setSize(500, 800);
        rightPanel.setLocation(600, 0);
        rightPanel.setBackground(MuiColors.secondary);
